...
const ProfileItem = ({
  profile: { _id, skills, user, company, location, status },
}) => {
  return (
    <div className='container'>
      <div className='row'>
        <div className='col-sm'>
          ...
          <div
            className='card bg-light mb-3 shadow'
          ...
          >
            ...
            <div className='card-body'>
              ...
              <p className='card-text'>
                <FontAwesomeIcon icon={faUserTie} /> {status}
              </p>
              {skills.map((skill, index) => {
                return (
              ...
              <Link
                to={`/profile/${_id}`}
                className='btn btn-md btn-info text-light mt-3'
              >
                View Profile
              </Link>
            </div>
